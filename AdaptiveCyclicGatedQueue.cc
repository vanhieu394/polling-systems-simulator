...
private:
    ...
    cMessage *packetServiceEvent;       // A packet has been served
...
public:
    AdaptiveCyclicGatedQueue();
    virtual~ AdaptiveCyclicGatedQueue();
protected:
...
Define_Module(AdaptiveCyclicGatedQueue);

AdaptiveCyclicGatedQueue::AdaptiveCyclicGatedQueue() {
...
void AdaptiveCyclicGatedQueue::initialize() {
    ...
    packetServiceEvent = new cMessage("A packet has been served");
}

void AdaptiveCyclicGatedQueue::finish() {
...
void AdaptiveCyclicGatedQueue::handleMessage(cMessage *msg) {
